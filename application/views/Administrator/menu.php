        ...
        <ul class="submenu">
            ...
            <li class="">
                <a href="<?php echo base_url(); ?>supplier_cheque">
                    <i class="menu-icon fa fa-caret-right"></i>
                    <span class="menu-text"> Supplier Cheque Entry </span>
                </a>
                <b class="arrow"></b>
            </li>
            <?php endif; ?>
...
<ul class="nav nav-list">
    ...
    <?php if (
			...
			|| array_search("bank_transaction_history", $access) > -1
...
<ul class="nav nav-list">
    ...
    <?php if (array_search("employee-loan", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>employee-loan">
            <i class="menu-icon fa fa-money"></i>
    ...
    <?php if (
			...
			|| array_search("employeeloanreport", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>" class="dropdown-toggle">
        ...
        <ul class="submenu">
            ...
            <?php if (array_search("employeeloanreport", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>employeeloanreport">
                    <i class="menu-icon fa fa-caret-right"></i>
