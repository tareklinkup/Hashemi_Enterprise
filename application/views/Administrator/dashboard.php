    ...
    <div class="col-md-12 col-xs-12">
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#e1e1ff;"
                    onmouseover="this.style.background = '#d2d2ff'" onmouseout="this.style.background = '#e1e1ff'">
            ...
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#dcf5ea;"
                    onmouseover="this.style.background = '#bdecd7'" onmouseout="this.style.background = '#dcf5ea'">
            ...
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#A7ECFB;"
                    onmouseover="this.style.background = '#85e6fa'" onmouseout="this.style.background = '#A7ECFB'">
            ...
            <!-- module/HRPayroll -->
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#ecffd9;"
                    onmouseover="this.style.background = '#cfff9f'" onmouseout="this.style.background = '#ecffd9'">
            ...
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#c6e2ff;"
                    onmouseover="this.style.background = '#91c8ff'" onmouseout="this.style.background = '#c6e2ff'">
            ...
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#e6e6ff;"
                    onmouseover="this.style.background = '#b9b9ff'" onmouseout="this.style.background = '#e6e6ff'">
            ...
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#d8ebeb;"
                    onmouseover="this.style.background = '#bddddd'" onmouseout="this.style.background = '#d8ebeb'">
            ...
            <div class="col-md-3 section4">
                <div class="col-md-12 section122" style="background-color:#ffe3d7;"
                    onmouseover="this.style.background = '#ffc0a6'" onmouseout="this.style.background = '#ffe3d7'">
...
<div class="row">
    <div class="col-md-12 col-xs-12">
        ...
        <div class="col-md-10">
            ...
            <?php if (array_search("supplier_cheque", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <div class="col-md-2 ">
                <div class="col-md-12 section20">
                    <a href="<?php echo base_url(); ?>supplier_cheque">
                        <div class="logo" style="margin-bottom:0">
                            <i class="menu-icon fa fa-book	"></i>
                        </div>
                        <div class="textModule" style="margin-top:0">
                            Supplier cheque Entry
                        </div>
                    </a>
                </div>
            </div>
...
<div class="row">
    <div class="col-md-12 col-xs-12">
        ...
        <div class="col-md-10">
            ...
            <?php if (array_search("bank_transaction_history", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <div class="col-md-2 ">
                <div class="col-md-12 section20">
                    <a href="<?php echo base_url(); ?>bank_transaction_history">
                        <div class="logo">
                            <i class="menu-icon fa fa-file-text-o"></i>
                        </div>
                        <div class="textModule" style="line-height: 13px; margin-top: 0;">
