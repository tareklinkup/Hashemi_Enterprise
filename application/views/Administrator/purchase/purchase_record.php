        ...
        <div class="col-md-12">
            <form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
                ...
                <div class="form-group" style="display:none;"
                    v-bind:style="{display: searchType == 'quantity' || searchType == 'supplier' && suppliers.length > 0 ? '' : 'none'}">
                    <label>Supplier</label>
                    <v-select v-bind:options="suppliers" v-model="selectedSupplier" label="display_name"
                        v-on:input="getProductsBySupplier"></v-select>
                </div>
                ...
                <div class="form-group"
                    v-bind:style="{display: searchType == '' || searchType == 'user' || searchType=='supplier' ? '' : 'none'}">
    ...
    <div class="row" style="margin-top:15px;display:none;" v-bind:style="{display: purchases.length > 0 ? '' : 'none'}">
        ...
        <div class="col-md-12">
            <div class="table-responsive" id="reportContent">
                ...
                <table class="record-table" v-if="searchType == 'category' || searchType == 'quantity'"
                    style="display:none;"
...
new Vue({
    ...
    methods: {
        onChangeSearchType() {
            ...
            if (this.searchType == 'supplier' || this.searchType == 'quantity') {
                this.getSuppliers();
        ...
        getProductsBySupplier() {
            ...
            axios.post('/get_products_by_supplier', formData).then(res => {
                this.products = res.data;
            })
        },
        getUsers() {
