							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 control-label no-padding-right">Commission</label>
												<div class="col-sm-12">
													<input type="number" id="freight" name="freight" class="form-control" v-model="purchase.commission" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		methods:{
			...
			calculateTotal(){
				...
				this.purchase.total = (parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) + parseFloat(this.purchase.freight)) - (this.purchase.discount+ +this.purchase.commission);
			...
			getPurchase(){
				axios.post('/get_purchases', {purchaseId: this.purchase.purchaseId}).then(res => {
					...
					this.purchase.commission = purchase.commission;
