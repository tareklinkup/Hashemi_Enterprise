			...
			<table class="table table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td style="text-align:right;">{{ this.ledger.reduce((prev,curr) => { return prev + parseFloat(curr.in_quantity)}, 0) }}</td>
						<td style="text-align:right;">{{ this.ledger.reduce((prev,curr) => { return prev + parseFloat(curr.out_quantity)}, 0) }}</td>
						<td></td>
					</tr>
				</tbody>
