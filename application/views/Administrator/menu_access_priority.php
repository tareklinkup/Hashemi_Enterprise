        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accountsReports">
                    ...
                    <li><input type="checkbox" class="access" value="bank_transaction_history" v-model="access"> Bank Transaction History</li>
                    <li><input type="checkbox" class="access" value="cash_view" v-model="access"> Cash View</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="hrPayroll">
                    ...
                    <li><input type="checkbox" class="access" value="employee-loan" v-model="access"> Employee Loan</li>
                    ...
                    <li><input type="checkbox" class="access" value="employeeloanreport" v-model="access"> Employee Loan Report</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
