				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control" v-model="selectedSupplier.Supplier_Address">
							</div>
						</div>

						<div class="form-group" style="display: none" :style="{display: selectedAccount == null ? 'none' : '' }">
							<label class="col-md-4 control-label">Bank Balance</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control" v-model="accountBalance" readonly>
							</div>
						</div>
						<div class="form-group">
